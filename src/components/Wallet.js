                ...
                {({ state, setState }) => (
                  <React.Fragment>
                    ...
                    >
                      ...
                      >
                        <Pane padding={16}>
                          <Heading size={300}>Add money to wallet</Heading>
                        </Pane>
                      </Pane>
                      <Pane
                        flex="1"
                      ...
                      >
                        <CreditCardInput
              cardNumberInputProps={{  onChange: this.handleNumberChange }}
              cardExpiryInputProps={{ onChange: this.handleNameChange }}
              cardCVCInputProps={{ onChange: this.handleCVCChange }}
